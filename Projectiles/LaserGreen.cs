...
namespace Emperia.Projectiles
{
    public class LaserGreen : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			Lighting.AddLight((int) projectile.Center.X / 16, (int) projectile.Center.Y / 16, 0f, 0.8f, 0f);
			float num1 = 100f;
			float num2 = 3f;
		...
		public override void Kill(int timeLeft)
		{
			...
			{
				int index2 = Dust.NewDust(projectile.Center - (projectile.velocity/2f), 0, 0, 220, 0.0f, 0.0f, 100, new Color(), 2.1f);
