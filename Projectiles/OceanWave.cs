...
namespace Emperia.Projectiles
{
    ...
    public class OceanWave : ModProjectile
    {
        ...
        {
            projectile.name = "Oceanic Wave";  //projectile name
		...
		{
			Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, mod.ProjectileType("WateryBoom"), 50, 5f, projectile.owner);
		}
