...
{
	public class RuinedChest : ModTile
	{
		public override void SetDefaults()
		{
			...
			AddMapEntry(new Color(43, 53, 39), "Ruined Chest", MapChestName);
		...
		{
			Item.NewItem(i * 16, j * 16, 32, 32, mod.ItemType("RuinedChest"));
		...
		public override void RightClick(int i, int j)
		{
			...
			for (int num66 = 0; num66 < 58; num66++)
                                    {
                                        if (player.inventory[num66].type == mod.ItemType("RuinedKey") && player.inventory[num66].stack > 0)
                                        {
		...
		public override void MouseOver(int i, int j)
		{
			...
			else
			{
				...
				if (player.showItemIconText == "Ruined Chest")
				{
					if (tile.frameX == 72 || tile.frameX == 90)
					{
						player.showItemIcon2 = mod.ItemType("RuinedKey");
